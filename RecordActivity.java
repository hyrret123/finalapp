...
import com.exam2.R;
import com.exam2.RecordActivity;
...
public class RecordActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//final ArrayList<Map<String, Object>> getEntryList = examResultService.getRecordEntryList(this);
		final ArrayList<Map<String, Object>> getEntryList = examResultService.getRecordEntryList(this, null, "totalScore desc", String.valueOf(10));
		...
		for (Map<String, Object> entry : getEntryList) {
			...
			entrylist.add(new ExamResultEntry((Integer) entry.get("_id"),
					...
					(String) entry.get("useTime"),(String) entry.get("usename")));
			count++;
		}
