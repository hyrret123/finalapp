...
import com.exam2.util.WindowUtil;
...
public class TopicActivity extends FragmentActivity {
	...
	public void toPreTopic(View view) {
		...
		*/
		...
		UiUtil.showToastShort(this, tc.getAnswer(daoId));
		toNextTopic(view);
	}
				...
				.setNegativeButton(getResources().getString(R.string.ok),
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								// TODO Auto-generated method stub
								//String useTime = ch_topic_test.getText().toString();
								int totalCount = tc.getRightCount()
										+ tc.getWrongCount();
								int totalScore = tc.getRightCount() * 4;
								...
								tc.addTestScore(totalScore, tc.getRightCount(),
										...
										dateTime, String.valueOf(totalTopic), app.getUsername());
